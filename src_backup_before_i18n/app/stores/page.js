...
function mapStore(s) {
  ...
  return {
    ...
    soldBattery: orderCount ? `${orderCount} 单` : (s.battery_count ? `${s.battery_count} 组` : '—'),
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {(() => {
            ...
            return [
              ...
              { icon: ShoppingBag, label: '累计销量', value: `${totalOrders}` },
              { icon: DollarSign, label: '累计收益', value: formatUSD(totalRevenue), secondary: `≈ ${formatCNY(usdToCny(totalRevenue))}` },
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-4 mt-2 text-xs">
                        ...
                        <span className="text-gray-500">收益 <span className="font-semibold text-gray-700">{s.revenueDisplay}</span>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  { label: '累计收益', value: selectedStore.revenueDisplay, secondary: selectedStore.revenueSecondary },
