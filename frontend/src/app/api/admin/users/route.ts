...
export async function GET(request: Request) {
  try {
    ...
    let query = supabase.from('users').select('id, email, username, full_name, phone, role, agent_type, kyc_status, is_active, total_investment, total_dividends, investor_code, created_at', { count: 'exact' })
