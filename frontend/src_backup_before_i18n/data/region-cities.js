...
export const PROVINCE_CITIES = {
  '北京': ['东城区', '西城区', '朝阳区', '海淀区', '丰台区', '石景山区', '通州区', '大兴区', '顺义区', '昌平区', '房山区', '其它'],
  '天津': ['和平区', '河东区', '河西区', '南开区', '河北区', '红桥区', '滨海新区', '西青区', '北辰区', '武清区', '其它'],
  '上海': ['黄浦区', '徐汇区', '长宁区', '静安区', '普陀区', '虹口区', '杨浦区', '浦东新区', '闵行区', '宝山区', '其它'],
  '重庆': ['渝中区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '渝北区', '巴南区', '万州区', '涪陵区', '其它'],
  ...
  '香港': ['香港岛', '九龙', '新界'],
  '澳门': ['澳门半岛', '氹仔', '路环'],
  '台湾': ['台北', '新北', '桃园', '台中', '台南', '高雄', '基隆', '新竹', '嘉义', '其它'],
};

/** 国家/地区 → 主要城市列表（非中国省份） */
export const REGION_CITIES = {
  'kh': ['金边', '暹粒', '西哈努克', '马德望', '贡布', '磅湛', '茶胶', '波萝勉', '菩萨', '其它'],
  'bd': ['达卡', '吉大港', '库尔纳', '拉杰沙希', '锡尔赫特', '巴里萨尔', '朗布尔', '迈门辛', '其它'],
};

/**
 * 根据省份名获取城市列表
 * @param {string} province - 省/直辖市名
 * @returns {string[]} 城市列表
 */
